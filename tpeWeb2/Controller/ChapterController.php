...
class ChapterController
{
    ...
    {
        if (!isset($_POST['nombreNuevo']) || empty($_POST['nombreNuevo']) || !isset($_POST['temporadaNueva']) || empty($_POST['temporadaNueva']) || !isset($_POST['estrenoNuevo']) || empty($_POST['estrenoNuevo']) || !isset($_POST['gagNuevo']) || empty($_POST['gagNuevo']) || !isset($_POST['id_directorNuevo']) || empty($_POST['id_directorNuevo'])) {
            $this->view->renderError("Error! contenido de celdas no especificado");
            return;
        }
